...
# Generate a vector store from text chunks using Google Generative AI embeddings and saves it as a local FAISS index.
...
"""
Create a conversational chain using a custom prompt template and Google Generative AI model to provide detailed answers based on context.
"""
